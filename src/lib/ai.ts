...
주어지는 원본 보도자료의 팩트(Fact)를 바탕으로, 저작권 및 검색엔진 중복 콘텐츠 패널티를 완벽히 우회하고 독자의 체류 시간을 극대화하는 "심층 가이드형 롱폼 전문 콘텐츠(공백 제외 최소 1,500자 ~ 2,200자 이상)"로 100% 재작성하십시오.
...
[작성 필수 지침 - 공백 제외 최소 1,500자 ~ 2,200자 롱폼 전문 가이드 작성]
1. 제목(title): [심층 분석], [속보] 같은 대괄호 태그나 ': 핵심 쟁점과 향후 전망' 같은 기계적 접미사를 절대 넣지 말고, 20~38자 내외의 매끄러운 정통 뉴스 헤드라인으로 새로 작문하십시오.
...
export function generateFallbackParaphrase(raw: RawArticleInput): RewrittenArticleResult {
  ...
  const isSmallBiz =
    cleanTitle.includes("소상공인") ||
    cleanTitle.includes("자영업자") ||
    cleanTitle.includes("소진공") ||
    cleanTitle.includes("기업마당") ||
...
이번 지원 사업은 일시적인 유동성 위기를 겪는 골목상권 영세 사업자부터 스마트 기술 도입과 재도전을 희망하는 성장형 소상공인까지 아우르는 촘촘한 안전망을 구축하는 데 그 목적이 있습니다. 정부와 유관 기관은 정책자금의 신속한 집행을 통해 민생 경제의 근간인 소상공인들이 실질적인 위기 극복과 도약의 기회를 잡을 수 있도록 총력 지원할 방침입니다.

## 2. 지원 대상 및 선정 기준 (소상공인 요건)

본 지원 사업은 「소상공인기본법」 제2조에 따른 소상공인 기준을 충족하는 개인 사업자 및 법인 사업자를 대상으로 지원 대상자를 엄격하게 심사·선정합니다.

### 소상공인 자격 요건 및 선정 기준
- **상시 근로자 수 기준:** 제조업·건설업·운수업은 10인 미만, 도소매업·음식점업·서비스업 등 일반 업종은 5인 미만 사업장
- **연평균 매출액 한도:** 업종별 중소기업기본법 시행령에 따른 소기업 매출액 기준(업종별 10억~120억 원 이하) 충족
- **업력 및 사업자 등록:** 공고일 현재 사업자등록증을 보유하고 정상적인 영업 활동을 영위 중인 실사업자
- **지원 제외(배제) 대상:** 금융기관 대출금 연체자, 국세 및 지방세 체납자, 유흥·도박 등 정책자금 융자제외 대상 업종 영위 사업자

${s2} 심사 과정에서는 국세청 홈택스 및 정부24 마이데이터 연계를 통해 매출 및 고용 현황을 실시간으로 교차 검증하며, 저신용 영세 소상공인의 경우 별도의 특례 심사 기준이 적용됩니다.

## 3. 지원 내용 및 한도 (금리, 지원금액 등)

이번 소상공인 정책자금은 시중은행 일반 사업자 대출 대비 대폭 낮은 우대 정책금리와 넉넉한 상환 거치 기간을 제공하여 이자 상환 부담을 최소화했습니다.

### 주요 정책자금 지원 항목 및 이전 대비 혜택 비교표

| 지원 자금 항목 | 일반 시중은행 대출 조건 | 2026 소진공 정책자금 (우대 조건) | 세부 지원 혜택 및 비고 |
| :--- | :--- | :--- | :--- |
| 대출 한도 (기업당) | 최대 3,000만~5,000만 원 | 최대 1억~2억 원 한도 | 유동성 공급 2배 이상 확대 |
| 대출 금리 (기준) | 연 5.5%~6.8% 수준 | 연 2.0%~3.2% 고정·변동 | 최대 3.5%p 이상 이자 감면 |
| 상환 방식 및 기간 | 3년 단기 원리금 균등 | 5년 (2년 거치 + 3년 분할상환) | 초기 원금 상환 부담 유예 |
| 보증료율 혜택 | 연 1.2%~1.5% 수준 | 연 0.5%~0.8% 우대 감면 | 보증료 부담 50% 이상 절감 |
| 부가 지원 프로그램 | 단순 융자 지원 한정 | 컨설팅 및 스마트상점 바우처 연계 | 경영 체질 개선 원스톱 지원 |

- **대출 한도 대폭 상향:** 일반 경영안정자금 및 특화자금의 경우 기업당 최대 1억 원에서 2억 원까지 한도가 대폭 확대되었습니다.
- **초저리 정책금리 적용:** 기준금리 인하 기조와 정부 이차보전을 결합하여 연 2%대 초반의 파격적인 우대금리를 지원합니다.
- **장기 거치 상환 지원:** 최장 2년 동안은 이자만 납부하고, 이후 3년간 원금을 분할 상환하도록 하여 사업 안정화 기간을 충분히 보장합니다.

### 체감형 혜택 시뮬레이션: 실제 적용 사례 및 지원 효과

연 매출 1억 5,000만 원 규모의 제조업 개인사업자 A씨의 경우, 이번 저리 정책자금 7,000만 원(연 2.5% 고정금리)을 지원받을 때 기존 시중은행 사업자 신용대출(연 6.2% 변동금리) 대비 연간 약 259만 원의 순수 이자 비용을 절감할 수 있습니다. 

특히 최장 2년 거치 기간 동안에는 매월 원금 상환 없이 약 14만 5,000원의 이자만 납부하면 되므로, 기존 대출 원리금 상환으로 인한 단기 유동성 압박을 획기적으로 완화하고 원자재 구매 및 매장 리모델링에 필요한 여유 자금을 안정적으로 운용할 수 있습니다.

## 4. 신청 방법 및 구비 서류

신청 접수는 소상공인의 생업 부담을 덜어주기 위해 전 과정 비대면 온라인 신청으로 진행되며, 디지털 취약 계층을 위한 현장 상담 창구도 함께 가동됩니다.

### 공식 신청 절차 및 구비 서류
- **공식 신청 누리집:** 소상공인정책자금 누리집(ols.semas.or.kr) 또는 중기부 기업마당(bizinfo.go.kr) 접속 후 공동인증서 로그인
- **필수 제출 서류:** 사업자등록증명, 부가가치세과세표준증명원(또는 면세사업자수입금액증명), 건강보험자격득실확인서(상시근로자 확인용)
- **온라인 자동 스크래핑:** 공공 마이데이터 동의 시 대부분의 증빙 서류가 자동 첨부되어 5분 이내에 전자 신청이 완료됩니다.
- **현장 방문 상담처:** 전국 소상공인시장진흥공단 지역센터(60여 개소) 및 지역신용보증재단 지점

${s3}

## 5. 신청 전 주의사항 & 반려 방지 체크리스트

소상공인 정책자금은 연간 배정된 정부 예산 범위 내에서 선착순으로 심사·지급되므로, 조기 마감에 유의하여 신속하고 정확하게 접수해야 합니다.

### 신청 전 주의사항 & 반려 방지 체크리스트
- **서류 유효기간 사전 점검:** 사업자등록증명 및 국세·지방세 납세증명서는 신청일 기준 최근 1개월 이내 발급분만 유효하며, 유효기간 만료 시 즉시 심사 보류 또는 반려 처리됩니다.
- **지원 제외(융자 배제) 업종 확인:** 주점업, 도박·사행성 업종, 부동산 임대업 등 정책자금 융자 지원 제외 업종은 신청 즉시 자동 탈락되므로 본인 사업자등록증 상의 업태·종목 코드를 사전에 확인하십시오.
- **중복 수혜 및 부채 비율 검증:** 당해 연도 중기부 또는 지자체의 동일 유사 경영안정자금을 이미 지원받았거나, 국세 체납 또는 금융기관 연체 이력이 전산망에 등록되어 있을 경우 지원이 원천 차단됩니다.
- **접수 개시 직후 신청 필수:** 자금별 배정 예산이 소진될 경우 당월 접수가 조기 마감될 수 있으므로 매월 공고 개시일 오전 9시 정각에 온라인 신청을 완료하는 것이 안전합니다.
- **불법 브로커 피해 주의:** 공단 및 지자체 직원을 사칭하여 수수료를 요구하거나 대출 승인을 보장한다는 사기 문자에 절대 응하지 마십시오.

세부 공고문 원문과 질의응답은 소상공인시장진흥공단 콜센터(국번없이 1357) 또는 공식 웹사이트(semas.or.kr)를 통해 실시간으로 확인하실 수 있습니다.
    `.trim();

  } else if (finalCategory === "정책·지원금") {
    content = `
## 1. 핵심 개요 및 주요 쟁점
...
기준 중위소득 100% 이하 가구의 취업준비 청년 B씨(만 27세)의 경우, 이번 지원 프로그램을 통해 매월 50만 원씩 12개월간 총 600만 원의 생활 안정 지원금을 수령할 수 있습니다. 

여기에 더해 직무 역량 강화 교육 바우처 연 200만 원 한도 및 취업 성공 시 추가 지급되는 100만 원의 취업 축하금까지 포함하면, 연간 총 900만 원 상당의 직접적인 경제적 혜택을 받게 됩니다. 이를 통해 생활비 부담을 크게 덜고 자격증 취득 및 면접 준비에 온전히 몰입할 수 있는 환경을 마련할 수 있습니다.
...
### 신청 전 주의사항 & 반려 방지 체크리스트
- **소득 증빙 서류 최신성 확인:** 건강보험료 납부확인서 및 소득금액증명원은 최근 3개월 이내 발급분만 유효하며, 최근 퇴직·휴직으로 소득 변동이 발생한 경우 퇴직증명서 등 증빙을 필히 첨부해야 감액이나 반려를 피할 수 있습니다.
- **중복 수혜 배제 규정 대조:** 국민취업지원제도, 타 지자체 청년수당, 생계급여 등 동일 유사 목적의 국비·지방비 지원금을 이미 수령 중인 경우 전산망 교차 검증을 통해 지원 대상에서 즉시 제외됩니다.
- **가구원 정보제공 동의 완료:** 공공 마이데이터 행정정보 연계 시 등본상 성인 가구원의 정보제공 동의가 누락되면 자격 심사가 장기 지연되거나 불인정될 수 있습니다.
- **접수 마감 시한 준수:** 마감 당일에는 전산망 접속 폭주로 제출 오류가 발생할 수 있으므로, 최소 마감 2일 전에 신청을 완료하고 접수 완료 번호를 반드시 메모해 두십시오.
    `.trim();
...
본 사안에 대한 공식적인 의견 개진은 소관 부처 민원 창구와 공공 토론 포털을 통해 가능하며, 객관적인 팩트에 근거한 균형 잡힌 시각을 유지하는 것이 바람직합니다.
  ...
  if (isSmallBiz) {
    defaultFaq = [
      {
        question: `${title.slice(0, 25)}의 지원 대상 및 소상공인 요건은 무엇인가요?`,
        answer: "「소상공인기본법」에 따른 상시근로자 수(제조업 10인 미만, 서비스업 등 5인 미만)와 연평균 소기업 매출액 기준을 충족하고 세금 체납이 없는 정상 영업 사업자입니다.",
      },
      {
        question: "정책자금 대출 한도와 금리 조건은 어떻게 되나요?",
        answer: "기업당 최대 1억~2억 원 한도로 연 2~3%대의 저리 정책금리가 적용되며, 최장 5년(2년 거치 포함) 분할상환 혜택이 주어집니다.",
      },
      {
        question: "신청 방법 및 필수 구비 서류는 무엇인가요?",
        answer: "소상공인정책자금 누리집(ols.semas.or.kr) 또는 기업마당(bizinfo.go.kr)에서 비대면 전자 접수가 가능하며, 사업자등록증명 및 부가세과세표준증명원을 온라인 제출하시면 됩니다.",
      },
    ];
  } else if (finalCategory === "정책·지원금" || finalCategory === "부동산·세제") {
    defaultFaq = [
      {
