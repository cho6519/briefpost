...
### 주요 금융 지표 비교 및 수치 혜택
| 금융 지원 항목 | 기존 시중 조건 | 정책 지원 조건 | 개선 효과 |
| :--- | :--- | :--- | :--- |
| 대환 대출 금리 | 연 7.5%~10.2% | 연 3.8%~4.5% 고정 | 최대 5.7%p 절감 |
| 특례 보증 한도 | 업체당 5,000만 원 | 최대 1억 원까지 | 보증 한도 2배 |
| 원금 상환 방식 | 1년 거치 3년 분할 | 3년 거치 10년 장기 | 월 상환액 완화 |
| 중도상환 수수료 | 1.2%~1.5% 부과 | 전액 면제(0원) | 수수료 부담 해소 |
...
### 주요 지원 규모 및 수치 혜택
| 프로그램 항목 | 이전 사업 규모 | 신규 확대 규모 | 수혜 체감 효과 |
| :--- | :--- | :--- | :--- |
| 1인당 지원 단가 | 연간 13만 원 | 연간 15만 원 이상 | 15% 이상 인상 |
| 지원 대상 인원 | 1만 명 내외 | 3만 명 이상 전격 확대 | 3배 수혜 확대 |
| 공공 시설 개방 | 주간 지정 요일 | 주 3회 야간 특별 개방 | 문화 접근성 제고 |
| 청년 예술 지원 | 프로젝트당 300만 원 | 최대 500만 원 지원 | 창작 환경 개선 |
